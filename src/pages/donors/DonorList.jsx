...
import { Plus, Search, MapPin, Phone, Calendar, UserCheck, Clock } from "lucide-react";
  ...
  return (
    <div className="page-container" style={{ padding: "20px", maxWidth: "1600px", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: "16px", marginBottom: "24px" }}>
        <div>
          <h1 style={{ fontSize: "1.8rem", fontWeight: "700", color: theme.colors.textPrimary, margin: 0 }}>Donor Registry</h1>
          <p style={{ color: theme.colors.textSecondary, marginTop: "4px" }}>Manage donor records and track eligibility.</p>
        </div>
        <button 
      ...
      <div style={{ 
        ...
        boxShadow: theme.shadows.card, marginBottom: "24px"
      }}>
      ...
      <div style={{ 
        ...
        {donors.map((donor) => (
          <div key={donor._id} style={{ 
            backgroundColor: "white", borderRadius: "12px", boxShadow: theme.shadows.card,
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start" }}>
              <div>
                ...
                <span 
                  ...
                  style={{ 
                    fontSize: "0.85rem", color: theme.colors.textSecondary, 
              ...
              <div style={{ 
                ...
                backgroundColor: "#FEE2E2", color: theme.colors.primary,
            ...
            {/* Details */}
            <div style={{ display: "grid", gap: "8px", fontSize: "0.9rem", color: "#4B5563" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                <Calendar size={16} /> Age: {new Date().getFullYear() - new Date(donor.dateOfBirth).getFullYear()}
              </div>
            </div>
            ...
            <div style={{ 
              ...
              <button style={{ fontSize: "0.85rem", color: theme.colors.primary, fontWeight: "600", background: "none", border: "none", cursor: "pointer" }}>
                View History →
              </button>
            </div>
          </div>
      ...
      {showModal && (
        <RegisterDonorModal onClose={() => setShowModal(false)} onSuccess={fetchDonors} />
      )}
    </div>
  );
};
